...
declare-option -hidden str lsp_symbol_kind_completion_advanced %{
    if [ $# -eq 1 ]; then
        ...
        # Whether to show hover info or goto symbol.
        printf 'hover\ngoto\n'
    fi
}
...
define-command lsp-previous-function -docstring "Goto the previous function in the buffer" %{
...
define-command lsp-previous-method -docstring "Goto the previous method in the buffer" %{
